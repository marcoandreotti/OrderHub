...
public sealed record AdditionalResponse(Guid Id, string Name, decimal Price, bool IsActive, int Order, bool IsAvailable = true, string? UnavailabilityReason = null, DateTimeOffset? AvailableAgainAt = null);
