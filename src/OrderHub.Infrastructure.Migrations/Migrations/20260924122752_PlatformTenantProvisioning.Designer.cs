...
namespace OrderHub.Infrastructure.Migrations.Migrations
{
    ...
    [Migration("20260924122752_PlatformTenantProvisioning")]
    partial class PlatformTenantProvisioning
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OrderHub.Domain.Operations.ServiceTable", b =>
                {
                    ...
                    b.Property<Guid?>("CreationIntent")
                        .HasColumnType("uuid")
                        .HasColumnName("creation_intent");
                    ...
                    b.HasIndex("TenantId", "EstablishmentId", "CreationIntent")
                        .IsUnique();
            ...
            modelBuilder.Entity("OrderHub.Domain.Tenancy.PlatformProvisioningIntent", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("ActorId", "Key")
                        .IsUnique()
                        .HasDatabaseName("ux_platform_provisioning_actor_key");

                    b.ToTable("platform_provisioning_intent", "tenancy");
                });
            ...
            modelBuilder.Entity("OrderHub.Domain.Tenancy.PlatformProvisioningIntent", b =>
                {
                    b.HasOne("OrderHub.Domain.Identity.PlatformUser", null)
                        .WithMany()
